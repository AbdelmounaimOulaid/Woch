                                ...
                                <div class="price__item white-bg mb-30 transition-3 fix active">
                                    ...
                                    <div class="price__content">
                                        <div class="price__amount mb-30 text-center">
                                            <h4 class="pricejs">$15.00 <span class="d-block"> per user/month</span></h4>
                                        </div>
                                        ...
                                        <div class="price__list mb-35">
                                            <ul>
                                                <li>Unlimited voice calling to 24 countries <span><i class="fa-solid fa-check"></i></span></li>
                                        ...
                                        <div class="price__btn">
                                            <a href="orderVoip.php" class="tp-btn-9 tp-btn-12 w-100">Order</a>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        select.addEventListener('change', function(e) {
            ...
            if (text == 'Annual Payment') {
                sessionStorage.setItem('price', '$500.00');
                document.querySelector('.pricejs').innerHTML = '$500.00 <span class="d-block"> per user/12 months</span>';
            } else {
                sessionStorage.setItem('price', '$15.00');
                document.querySelector('.pricejs').innerHTML = '$15.00 <span class="d-block"> per user/month</span>';
            }
        });
    </script>
</body>
