            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-right">
                            <li class="header-notification" style="padding-top: 3px;">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item" style="margin-top: 20px;">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="../../assets/Schedule.pdf" class="waves-effect waves-dark" download="schedule.pdf">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="#" class="waves-effect waves-dark request-number">
                                        <span class="pcoded-micon"><i class="fa-solid fa-square-phone"></i></span>
                                        <span class="pcoded-mtext">VoIP
                                            Number</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu">
                                    <a href="#" class="waves-effect waves-dark request-number">
                                        ...
                                        <span class="pcoded-mtext">Call
                                            Records</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu">
                                    <a href="Voip-Pack.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="fa-solid fa-cart-plus"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">VoIP
                                            Service</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu">
                                <a href="#" class="waves-effect waves-dark request-number">
                                        <span class="pcoded-micon"><i class="fa-solid fa-comments-dollar"></i></span>
                                        <span class="pcoded-mtext">Compensation</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
