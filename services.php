...
<body>
    <div class="main-wrapper">
        ...
        <!-- /*** */ include header ***/ -->
        <section class="error__area pt-115 pb-120 items-three" id="content">
        <div class="page-banner">
            ...
            <div class="container">
                <!-- About Section Start -->
                <section class="about-page-section rpt-90">
                    <div class="container">
