...
<body>
    <div class="main-wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-12">
                        <h1 class="mb-0">About Hoch Institute</h1>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-12">
                        ...
                        <div class="section-text aos" data-aos="fade-up">
                            ...
                            <a href="contact.php" class="tp-btn-green">Get Started</a>
                        </div>

                    </div>
                    <div class="col-lg-5 col-md-12 d-flex align-items-end">
                        <div class="career-img aos div-about" data-aos="fade-up">
                            <img src="assets/img/about/main.jpg" alt="" class="img-fluid img-about">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2" data-aos="fade-left" data-aos-duration="2000">
                        <div class="counter-wrap style-two wow fadeInRight delay-0-4s">
                            <div class="success-item">
                                <span class="count-text plus" data-speed="3000" data-stop="3751">3751</span>
                                <span>Enrolled Learner</span>
                            </div>
                            <div class="success-item">
                                <span class="count-text plus" data-speed="3000" data-stop="236">7854</span>
                                <span>Finished Session</span>
                            </div>
                            <div class="success-item">
                                <span class="count-text percent" data-speed="3000" data-stop="99">90.15</span>
                                <span>Saticfaction Rate</span>
                            </div>
                            <div class="success-item">
                                <span class="count-text plus" data-speed="3000" data-stop="83">12</span>
        ...
        <section class="research__area pt-4 pb-60" style="margin: 60px 0;">
            <div class="container">
                <div class="section-header aos" data-aos="fade-up" id="teams">
