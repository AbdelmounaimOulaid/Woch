    ...
    <div class="main-wrapper">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col d-flex justify-content-center flex-column align-items-center orderVoIP">

                    <h2>Here's your new phone number.</h2>

                    <div class="moustatil"></div>

                    <h3>+1 (205) 683-6047</h3>
                    ...
                    <div class="text">
                        ...
                        <ul>
                            ...
                            <li>Any use of the provided number for personal, suspicious, or illegal purposes will result in an immediate suspension until further notice.

                            </li>

                            <li>To obtain approval to use the provided number, it will take approximately 4 to 6 business days. Thank you for your patience.</li>

                        </ul>

                    </div>

                    <a href="https://buy.stripe.com/7sI2aFbA1aVVepG28q">Next</a>


                    <div class="text-center" style="font-size: 15px;">

                        Powered by <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="svg-78604338-263886854-title" class="logo__img" fill="none" height="100" id="svg-78604338-263886854" role="img" viewBox="0 0 961 208" width="100">
